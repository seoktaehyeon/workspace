...
作为一个 *~~瞎折腾~~* 复杂、多元且敏捷的 DevOps 团队，消息通知一直让人又爱又恨。

就像垃圾消息一样，总是堆满弹窗。

<img style="width:100%" src="https://vstone.gitee.io/workspace/assets/posts/2021-04-28-pic-1.jpg"/>

无脑转发、群聊、风格各异、消息提示音…… 犹如一场交响乐，在脑海中回荡。最终，所有人都感谢一个叫 **屏蔽** 的功能。

<img style="width:100%" src="https://vstone.gitee.io/workspace/assets/posts/2021-04-28-pic-2.png"/>
...
<img style="width:100%" src="https://vstone.gitee.io/workspace/assets/posts/2021-04-28-msg-7.png"/>
...
<img style="width:100%" src="https://vstone.gitee.io/workspace/assets/posts/2021-04-28-msg-6.png"/>
...
所以这里我展示以下 Markdown 的消息模板：

```markdown
#### [{{key}} {{fields.summary}}](http://0.0.0.0/browse/{{key}})

{% if {{fields.assignee.displayName}} %}
{{fields.creator.displayName}} 上报了该 {{fields.issuetype.name}} 并分配给了 {{fields.assignee.name}}
{% else %}
{{fields.creator.displayName}} 上报了该 {{fields.issuetype.name}}
{% end %}
```
