...
[![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/github-repo.png)](https://github.com/seoktaehyeon/sraFramework)
...
![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/dir-description.png)
...
![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/github-workflow-1.png)

![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/github-workflow-2.png)

![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/github-workflow-3.png)
...
![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/allure-1.png)

用中文关键字表示测试步骤，冲破语言障碍。

![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/allure-2.png)

虽然是在一个没有图形化界面的容器中执行，但使用谷歌的 headless 模式启动 Chrome，网页元素还是加载渲染的，对关键操作进行截图自然不在话下。

![图片]({{ site.post_img_path }}/{{ page.post_img_dir }}/allure-3.png)
