...
[<img style="width:100%" src="//vstone.gitee.io/workspace/assets/posts/2021-02-25-github-repo.png"/>](https://github.com/seoktaehyeon/sraFramework)
...
![目录结构](https://vstone.gitee.io/workspace/assets/posts/2021-02-25-dir-description.png)
...
![拉取镜像](https://vstone.gitee.io/workspace/assets/posts/2021-02-25-github-workflow-1.png)

![开始执行测试](https://vstone.gitee.io/workspace/assets/posts/2021-02-25-github-workflow-2.png)

![测试执行完成](https://vstone.gitee.io/workspace/assets/posts/2021-02-25-github-workflow-3.png)
...
![总览](https://vstone.gitee.io/workspace/assets/posts/2021-02-25-allure-1.png)

用中文关键字表示测试步骤，冲破语言障碍。

![测试步骤](https://vstone.gitee.io/workspace/assets/posts/2021-02-25-allure-2.png)

虽然是在一个没有图形化界面的容器中执行，但使用谷歌的 headless 模式启动 Chrome，网页元素还是加载渲染的，对关键操作进行截图自然不在话下。

![步骤截图](https://vstone.gitee.io/workspace/assets/posts/2021-02-25-allure-3.png)
